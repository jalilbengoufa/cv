...
pdfkit.from_file('html/index-page-1-fr.html', 'cv-1-fr.pdf')
pdfkit.from_file('html/index-page-2-fr.html', 'cv-2-fr.pdf')
pdfkit.from_file('html/index-page-1-en.html', 'cv-1-en.pdf')
pdfkit.from_file('html/index-page-2-en.html', 'cv-2-en.pdf')
